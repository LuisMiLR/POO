...
//Heritage des proprietés (ou attribues) et des fonctions

//class Admin extends va hériter de la classe Utilisateur
...
//declaration d une liste des utilisateurs
let utilisateurs = [util1, util2, admin];
console.log(utilisateurs); // nous permet d'avoir un array d'objet utilsiateur avec l'admin

admin.supprimerUtilisateurs(util1);
console.log(utilisateurs);//l utilisateur en parametre de la fonction supprmier à bien été suprrimer
